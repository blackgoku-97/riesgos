...
class ValidacionService {
  static String? validar({
    ...
    if (opcionesProceso[areaEnum]!.isNotEmpty && (proceso == null || proceso.isEmpty)) {
      return 'Debes seleccionar un proceso';
    }
    if (opcionesActividad[areaEnum]!.isNotEmpty && (actividad == null || actividad.isEmpty)) {
      return 'Debes seleccionar una actividad';
    }
    if (opcionesPeligro[areaEnum]!.isNotEmpty && (peligros == null || peligros.isEmpty)) {
      return 'Debes seleccionar al menos un peligro';
    }
    if (opcionesAgenteMaterial[areaEnum]!.isNotEmpty && (agenteMaterial == null || agenteMaterial.isEmpty)) {
